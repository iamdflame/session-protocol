// Pyth's Lazer verifier, pyth-lazer-solana-contract 0.8.0, Apache-2.0: see lib.rs.
...
// SESSION: the one item this file used from `pyth-lazer-protocol`, written out
// (change 2): `message::format_magics_le::SOLANA_FORMAT_MAGIC`.
const SOLANA_FORMAT_MAGIC: u32 = 2182742457;
