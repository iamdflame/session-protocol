...
import { useMarkets, useStudy, fmtPct, fmtPctAbs, type StudyAsset } from '@/lib/data';
        ...
        <Reveal>
          <div className={s.repro}>
            <p>
              ...
              page, and <code className="mono">npm test</code> runs the 103 Rust tests and
              three TypeScript suites that pin the calendar and the settlement maths to
              each other.
            </p>
